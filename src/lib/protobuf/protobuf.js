    ...
    default: {
        PTP: {
            ...
            Common: {
                ...
                ERR: {
                    '@': {"NO_ERROR":0,"E_SYSTEM":1,"E_REASON_NO_ROUTE_SERVER":5,"E_REASON_NO_LOGIN_SERVER":6,"E_REASON_NO_DB_SERVER":7,"E_LOGIN_ERROR":8,"E_PB_PARSE_ERROR":9,"E_SWITCH_USER_NO_ONLINE":10,"E_USERNAME_EXISTS":11,"E_USERNAME_INVALID":12,"E_CLIENT":1003,"E_CLIENT_TIMEOUT":1004,"E_SERVER_NOT_FOUND":404,"E_GROUP_CREATE_PAIR_GROUP_MEMBER_SIE_INVALID":1101,"E_GROUP_CREATE_PAIR_GROUP_NO_REG_USER":1102,"E_GROUP_HAS_CREATED":1103,"E_GROUP_CREATE_PAIR_EXISTS":1104,"E_GROUP_MODIFY_INVALID_ACTION":1105,"E_BUDDY_MODIFY_INVALID_ACTION":1201}
                },
                GroupInfo: {
                    '$': {"1":["group_adr","string",""],"2":["name","string",""],"3":["avatar","string",""],"4":["owner_uid","uint32",0],"5":["pair_uid","uint32",0],"6":["group_type","uint32",1],"7":["group_idx","uint32",0],"8":["created_time","uint32",0],"9":["group_id","uint32",0],"10":["updated_time","uint32",0],"11":["about","string",""]}
                },
                GroupMember: {
                    '$': {"1":["uid","uint32",0],"2":["member_status","uint32",1]}
                },
                GroupMemberModifyAction: {
                    '@': {"GroupMemberModifyAction_ADD":2,"GroupMemberModifyAction_STATUS":3}
                },
                GroupMemberStatus: {
                    '@': {"GROUP_MEMBER_STATUS_DEL":1,"GROUP_MEMBER_STATUS_NORMAL":10}
                },
                GroupModifyAction: {
                    '@': {"GroupModifyAction_name":1,"GroupModifyAction_avatar":2,"GroupModifyAction_about":3}
                },
                GroupRecord: {
            ...
            Group: {
                ...
                GroupChangeMemberReq: {
                    '$': {"1":["group_member_modify_action","uint32",2],"2":["group_id","uint32",0],"3":["members","[uint32",null],"4":["group_member_status","uint32",1],"20":["attach_data","bytes",[]],"21":["auth_uid","uint32",0]}
                },
                GroupChangeMemberRes: {
                    '$': {"3":["group_id","uint32",0],"4":["notify_members","[uint32",null],"5":["error","uint32",0],"20":["attach_data","bytes",[]],"21":["auth_uid","uint32",0]}
                },
                GroupCreateReq: {
                ...
                GroupGetListRes: {
                    '$': {"1":["group_info_updated_time","uint32",0],"2":["groups","<default.PTP.Common.GroupInfo",null],"3":["error","uint32",0],"4":["removed_group_ids","[uint32",null],"20":["attach_data","bytes",[]],"21":["auth_uid","uint32",0]}
                },
